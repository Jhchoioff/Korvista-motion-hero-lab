...
- **Cinematic / Scroll Reveal 01 — Held in Place**  
  Scroll-pinned hero where scene cross-fades and headline transitions are driven entirely by
  scroll position, not autoplay timers or pointer movement. Three real photographs (lounge,
  infinity pool, sunset terrace).
